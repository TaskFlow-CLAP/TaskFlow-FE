...
export const SIDE_MANAGER_MENU: SideMenu[] = [
  {
    ...
    groupTitle: '작업',
    items: [
      { menuId: 11, content: '내 작업', link: '/my-task', role: 'manager' },
      { menuId: 12, content: '작업 보드', link: '/task-board', role: 'manager' },
      { menuId: 13, content: '팀 작업 현황', link: '/team-board', role: 'manager' },
      { menuId: 14, content: '통계', link: '/statistics', role: 'manager' }
    ]
  },
  {
    groupId: 2,
    groupTitle: '요청',
    items: [
      { menuId: 21, content: '내 요청', link: '/my-request', role: 'manager' },
      { menuId: 22, content: '작업 요청', link: '/task-request', role: 'manager' },
      { menuId: 23, content: '승인 대기중인 요청', link: '/requested', role: 'manager' },
      { menuId: 24, content: '전체 요청 기록', link: '/request-history', role: 'manager' }
    ]
  }
]
